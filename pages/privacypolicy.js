...
function PrivacyPolicy() {
  return (
    <div>
      <Head>
        <title>Privacy Policy - QuickApps</title>
      </Head>

      <div className='mx-auto py-14'>
        <div className='space-y-4 '>
          <div className=' py-10 bg-gray-700 dark:bg-gray-400'>
            <h1 className='max-w-6xl mx-auto text-center text-4xl text-gray-100'>
              Privacy Policy
            </h1>
          </div>
          <div className='space-y-6 max-w-6xl mx-auto dark:text-gray-100 px-4'>
            <p>Effective date: 2020-07-24</p>
            <h3 className='text-2xl'>
              1. <strong>INTRODUCTION</strong>
            </h3>
            <p>
              Welcome to <strong>QuickBusiness</strong>.
            </p>
            <p>
              <strong>QuickApps</strong> (“us”, “we”, or “our”) operates
              <strong> QuickBusiness </strong>and
              <strong> QuickBusiness Book</strong> (hereinafter referred to as
              <strong>“Service”</strong>).
            </p>
            <p>
              Our Privacy Policy governs your use of
              <strong>QuickBusiness </strong>and
              <strong> QuickBusiness Book</strong>, and explains how we collect,
              safeguard and disclose information that results from your use of
              our Service.
            </p>
            <p>
              We use your data to provide and improve Service. By using our
            ...
            <p>
              <strong>SERVICE</strong> means the <strong>QuickBusiness </strong>
              and<strong> QuickBusiness Book</strong> applications operated by
              QuickApps.
            </p>
            <p>
            ...
            <h4 className='text-2xl'>
              4.1 <strong>Personal Data</strong>
            </h4>
            <p>
            ...
            <h4 className='text-2xl'>
              4.3 <strong>Tracking Cookies Data</strong>
            </h4>
            <p>
            ...
            <p>
              4.3.1 <strong>Session Cookies:</strong> We use Session Cookies to
              operate our Service.
            </p>
            <p>
              4.3.2 <strong>Preference Cookies:</strong> We use Preference
              Cookies to remember your preferences and various settings.
            </p>
            <p>
              4.3.3 <strong>Security Cookies:</strong> We use Security Cookies
              for security purposes.
            </p>
            <p>
              4.3.4 <strong>Advertising Cookies:</strong> Advertising Cookies
              are used to serve you with advertisements that may be relevant to
              you and your interests.
            </p>
            <h3 className='text-2xl'>
              5. <strong>USE OF DATA</strong>
            </h3>
            <p>QuickApps uses the collected data for various purposes:</p>
            ...
            <p>
              ...
              and maintained on – computers located outside of your country or
            ...
            <p>
              QuickApps will take all the steps reasonably necessary to ensure
            ...
            <h4 className='text-2xl'>
              8.1. <strong>Disclosure for Law Enforcement.</strong>
            </h4>
            <p>
            ...
            <h4 className='text-2xl'>
              8.2. <strong>Business Transaction.</strong>
            </h4>
            <p>
            ...
            <p>
              8.3.2. to contractors, service providers, and other third parties
              we use to support our business;
            </p>
            <p>8.3.3. to fulfill the purpose for which you provide it;</p>
            <p>
              8.3.4. for the purpose of including your company’s logo on our
              website;
            </p>
            <p>
              8.3.5. for any other purpose disclosed by us when you provide the
              information;
            </p>
            ...
            <h3 className='text-2xl'>
              10. <strong>SERVICE PROVIDERS</strong>
            </h3>
            <p>
            ...
            <h3 className='text-2xl'>
              13. <strong>Links to Other Sites</strong>
            </h3>
            <p>
            ...
            <h3 className='text-2xl'>
              14. <strong>Children’s Privacy</strong>
            </h3>
            <p>
              Our Services are not intended for use by children under the age of
              16 (<strong>“Child”</strong> or <strong>“Children”</strong>).
            </p>
            <p>
            ...
            <h3 className='text-2xl'>
              15. <strong>Changes to This Privacy Policy</strong>
            </h3>
            <p>
            ...
            <h3 className='text-2xl'>
              16. <strong>Contact Us</strong>
            </h3>
            <p>
              If you have any questions about this Privacy Policy, please
              contact us by email:
              <strong>
                <Link href='mailto:quickservicesapp@gmail.com'>
                  quickservicesapp@gmail.com
                </Link>
              </strong>
              .
            </p>
